...
async fn main() -> Result<(), Error> {
    ...
    log::info!("Starting multi task demo...");
    log::info!("Ensure an EK1100 or EK1501 is the first SubDevice, with an EL3004 after");
    ...
    let sdo_read_task = tokio::spawn({
        ...
        async move {
            let el3004 = group
                ...
                .expect("Second subdevice (should be an EL3004) not present");
            ...
            loop {
                ...
                let data: u32 = el3004.sdo_read(0x1c12, 0).await.expect("Couldn't read SDO");
    ...
    let group = Arc::into_inner(group)
        .expect("Group handle still held!")
